    ...
    <div class="page-container">
        ...
        <div class="page-content">
            ...
            <div class="page-body">
                <!-- 菜单列表 -->
                <div class="row">
                    <h5 class="row-title" style="margin-left: 20px;"><a href="<?php echo url('','','user_lists');?>"><i class="typcn typcn-lightbulb"></i>用户列表</a></h5>
                    <h5 class="row-title" style="margin-left: 20px;"><a href="<?php echo url('','','user_add');?>"><i class="typcn typcn-lightbulb"></i>添加用户</a></h5>

                    <div class="col-xs-12">
                        <div class="col-xs-12">
                            <div class="widget radius-bordered">
                                <div class="widget-header">
                                    <span class="widget-caption"><?php echo isset($data['d_user_model']['id'])?'编辑用户':'添加用户'; ?></span>
                                </div>
                                <div class="widget-body">
                                    <form id="Form" method="post" class="form-horizontal">
                                        <input type="hidden" id="user_id" name="info[id]" value="<?php echo $data['d_user_model']['id']??0;?>">
                                        <div class="form-title" style="display: none">
                                            添加用户
                                        </div>
                                        <div class="form-group">
                                            <label class="col-lg-4 control-label">邮  箱</label>
                                            <div class="col-lg-8">
                                                <input type="text" class="form-control" name="info[email]" value="<?php echo $data['d_user_model']['email']??'';?>"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="text" class="form-control" name="info[user_name]" value="<?php echo $data['d_user_model']['user_name']??'';?>"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <textarea name="info[description]" class="form-control" rows="3"><?php echo $data['d_user_model']['description']??'';?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <input style="position: initial;opacity: inherit;" type="radio" name="info[status]" <?php echo  isset($data['d_user_model']['status'])&&$data['d_user_model']['status']==1 ? 'checked':'';?> value="1">启用
                                                <input style="position: initial;opacity: inherit;" type="radio" name="info[status]" <?php echo  isset($data['d_user_model']['status'])&& $data['d_user_model']['status']==0 ? 'checked':'';?> value="0">禁用
                                            </div>
                                        </div>
    ...
    $(document).ready(function () {
        ...
        $("#Form").bootstrapValidator({
            ...
            submitHandler: function (validator, form, submitButton) {
                ...
                //alert('here.')
                if(user_id==0){
                    var url = '<?php echo url('','','user_add');?>';
                }else{
                    var url = '<?php echo url('','','user_edit');?>';
                }
