                                                    ...
                                                    <div class="widget radius-bordered">
                                                        ...
                                                        <div class="widget-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-lg-8">
                                                                    <script id="editor" type="text/plain">{$array_magazine_article.body|htmlspecialchars_decode}</script>
...
<script type="text/javascript">
    <!--
    var ueditor_server_url = '<?php echo url("Admin","Content","ueditor",['token'=>$token]);?>';
    //-->
</script>
