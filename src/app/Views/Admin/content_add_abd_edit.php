                                                ...
                                                <div id="tab1" class="tab-pane active">
                                                    <div class="widget radius-bordered">
                                                        ...
                                                        <div class="widget-body">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-lg-4 control-label">上级内容：</label>
                                                                <div class="col-lg-4">
                                                                    <select class="form-control" name="info[parent_id]" style="">
                                                                        <option value="0">≡ 作为一级内容 ≡</option>
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-lg-4 control-label">内容名称：</label>
                                                                <div class="col-lg-8">
                                                                    <input type="text" class="form-control" name="info[catname]"/>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-lg-8">
                                                                    <input class="form-control" name="info[catdir]" type="text"/>
                                                                </div>
                                                            </div>

                                                            <div class="form-group">
                                                                <label class="col-lg-4 control-label">内容图片：</label>
                                                                <div class="col-lg-8">
                                                                    <div class="layui-upload-drag" id="test10">
                                                                        <i class="layui-icon">&#xe67c;</i>
                                                                        <p>点击上传，或将文件拖拽到此处</p>
                                                                    </div>
                                                                    <input class="form-control" name="info[image]" type="text"/>
                                                                </div>
                                                            </div>
                                                ...
                                                <div id="tab2" class="tab-pane">
                                                    <div class="widget radius-bordered">
                                                        ...
                                                        <div class="widget-body">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-lg-4 control-label">META Title（内容标题）：</label>
                                                                <div class="col-lg-8">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-lg-4 control-label">META Keywords（内容关键词）：</label>
                                                                <div class="col-lg-8">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-lg-4 control-label">META Description（内容描述）：</label>
                                                                <div class="col-lg-8">
