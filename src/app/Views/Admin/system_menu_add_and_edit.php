                                ...
                                <div class="widget-body">
                                    <form id="registrationForm" method="post" class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <input style="position: initial;opacity: inherit;" type="radio" name="status" <?php echo  isset($data['d_menu_model']['status'])&&$data['d_menu_model']['status']==1 ? 'checked':'';?> value="1">显示
                                                <input style="position: initial;opacity: inherit;" type="radio" name="status" <?php echo  isset($data['d_menu_model']['status'])&&$data['d_menu_model']['status']==0 ? 'checked':'';?> value="0">隐藏
                                            </div>
                                        </div>
