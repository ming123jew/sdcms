...
class Webpage extends Base
{
    ...
    protected $weixin_xougou_http_client;
    ...
    public function __construct(string $proxy = ChildProxy::class)
    {
        ...
        get_instance()->addAsynPool('weixin_xougou_http_client',new HttpClientPool($this->config,'http://weixin.sogou.com/'));
        $this->weixin_xougou_http_client =  get_instance()->getAsynPool('weixin_xougou_http_client');
    ...
    public function http_get_url()
    {
        ...
        $ip= long2ip(mt_rand($this->ip_long[$rand_key][0], $this->ip_long[$rand_key][1]));
        //$this->weixin_xougou_http_client = get_instance()->getAsynPool('weixin_xougou_http_client');
        $response = yield $this->weixin_xougou_http_client->httpClient
            ->addHeader('CURLOPT_USERAGENT',$this->agent[rand(0, count($this->agent) - 1)])
        ...
        //print_r($this->weixin_xougou_http_client->httpClient->toArray());
        //print_r($response);
     ...
     * @return $string
     */
    private function _htmlTransform($string)
    {
