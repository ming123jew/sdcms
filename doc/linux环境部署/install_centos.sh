...
install_php()
{
    ...
    echo -e "opcache.enable=1\nopcache.enable_cli=1\nzend_extension=opcache.so" |  tee ${php_ini_dir}/conf.d/10-opcache.ini
     rm -f ${pwd}/php-${php_version}.tar.gz
     rm -rf ${pwd}/php-${php_version}
}
