...
//
$crawler = new WxCrawler();
$url = 'http://mp.weixin.qq.com/s?src=11&timestamp=1524550329&ver=835&signature=BAAk*YX8OFbkPZA-CS-XGUdmDLfEzq2ygd2facibL5BAjOc4VvKkNROt98jYzNJHS3cjddDoi6Q4ZEfbZJSpiNu1UWvi8qvemt9D4*0xzMUdr1*f2GGxvTWsoDIwunsE&new=1';
$content = $crawler->crawByUrl($url);
print_r($content);
